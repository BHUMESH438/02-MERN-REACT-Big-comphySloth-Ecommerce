  ...
  return (
    <div>
      ...
      <form id='payment-form' onSubmit={handleSubmit}>
        ...
        {/* check any value is true for btn */}
        ...
        {failed && <h4>payment failed redirecting to home page in 20sec and cart will be cleard automatically........</h4>}
        {/* show a success message upon completion */}
        <p className={succeeded ? 'result-message' : 'result-message hidden'}>
          payment succeeded see the result in your <a href={`https://dashboard.stripe.com/test/payments`}> stripe payment dashboard</a> Refresh page to pay again
        </p>
      </form>
    </div>
  );
